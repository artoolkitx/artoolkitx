...
#ifdef __linux
#  define _GNU_SOURCE   // // Defines _LARGEFILE64_SOURCE if using GNU libc.
#endif
...
#else
#  if defined(__FreeBSD__) || defined(__NetBSD__) || defined(__DragonFly__) || defined(__OpenBSD__) || defined(__APPLE__) || defined(__ANDROID__) || defined(__EMSCRIPTEN__)
#    define fopen64 fopen
